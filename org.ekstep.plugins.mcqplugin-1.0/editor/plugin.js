 ...
 */
mcqplugin.EditorPlugin = org.ekstep.contenteditor.basePlugin.extend({
   ...
   /**
    ...
    initialize: function() { 
        ...
        var templatePath = ecEditor.resolvePluginResource(instance.manifest.id, instance.manifest.ver, 'editor/createquestionui.html');
        var controllerPath = ecEditor.resolvePluginResource(instance.manifest.id, instance.manifest.ver, 'editor/createquestionapp.js');
    ...
    newInstance: function() {
        ...
        delete props.width;
        delete props.height;
        var imageURL = ecEditor.resolvePluginResource(this.manifest.id, this.manifest.ver, 'assets/createquestion.png');
